...
const products = [
  ...
  { number:"02", name:"DII Accounts", label:"Finance operations", description:"Keep invoices, expenses, CSV bank activity and review-ready records together.", for:"UK freelancers, sole traders and growing businesses.", problem:"Daily finance records are fragmented across tools and spreadsheets.", outcome:"A calmer record of what came in, went out and needs attention.", url:"https://accounts.dii.ltd/" },
  { number:"03", name:"Rotaplan", label:"People operations", description:"Plan shifts, coverage and allowance-aware work with less day-to-day coordination friction.", for:"Managers and teams running shift-based operations.", problem:"Rota changes and coverage gaps are difficult to follow.", outcome:"Clearer weekly planning and team coordination.", url:"https://www.aryabiz.co.uk/" },
  { number:"04", name:"Warewise", label:"Warehouse operations", description:"Keep stock, locations and warehouse movement visible as operations grow.", for:"Warehouse and stock-handling teams.", problem:"Inventory activity becomes hard to see and control.", outcome:"Clearer stock visibility and fewer operational blind spots.", url:"https://www.northstarwms.co/wms" },
  { number:"05", name:"IFV", label:"Founder-visa preparation", description:"Build a stronger Innovator Founder Visa venture case with clearer evidence and founder readiness.", for:"Founders preparing for the UK Innovator Founder Visa route.", problem:"Venture logic and endorsement preparation need to work together.", outcome:"A better-structured, evidence-aware founder case.", url:"https://www.dhruviinfinity.com/ifv" },
] as const;
